...
import seasonOne from "./seasonOne.js";


export let storyNumber = 12;
export let lastStoryNumber = seasonOne.length;
...
export const episodesPanel = {
  ...
  open() {
    ...
    if(window.outerWidth <= 600) {
      sidePanelIcon.src = '/governanceHubAssets/sideIconMobileOpen-Inactive.avif';
